...
public class Chamada1Professor {
  ...
  @Test
  public void testChamada1Professor() throws Exception {
    ...
    driver.findElement(By.cssSelector("a.tab-item.activated > span.tab-title.ng-binding")).click();
    driver.findElement(By.xpath("//a[2]/span")).click();
    driver.findElement(By.xpath("(//input[@type='text'])[2]")).clear();
    driver.findElement(By.xpath("(//input[@type='text'])[2]")).sendKeys("90");
    driver.findElement(By.xpath("(//input[@type='text'])[3]")).clear();
    driver.findElement(By.xpath("(//input[@type='text'])[3]")).sendKeys("80");
    driver.findElement(By.xpath("//div/div[3]/div[2]/button")).click();
    driver.findElement(By.cssSelector("span.tab-title.ng-binding")).click();
    driver.findElement(By.xpath("//div/div/div[2]/button")).click();
    driver.findElement(By.xpath("//div/div/div[2]/button")).click();
