...
public class ProfessorChamada {
  ...
  @Test
  public void testProfessorChamada() throws Exception {
    ...
    driver.findElement(By.xpath("//div/div/div[2]/button")).click();
    driver.findElement(By.xpath("//ion-content/div[1]/div/div[2]/button")).click();
    driver.findElement(By.xpath("//ion-content/div[1]/div[4]/div[2]/button")).click();
