...
// JUnit 4.3
public class presenca0704hTestCasesMD1{
	
	public static junit.framework.Test suite(){
		return new junit.framework.JUnit4TestAdapter(presenca0704hTestCasesMD1.class);
	}
